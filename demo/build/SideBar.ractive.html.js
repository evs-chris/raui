System.register(['ractive', './chunk2.js', './chunk16.js'], function (exports, module) {
  'use strict';
  ...
  return {
    ...
    execute: function () {
      ...
      var SideBar = /*@__PURE__*/(function (Ractive) {
        ...
        SideBar.prototype.select = function select (idx) {
        ...
        SideBar.prototype.toggle = function toggle (key) {
          if (key === undefined) {
            return Ractive.prototype.toggle.call(this, 'open');
          } else {
      ...
      globalRegister('RMSideBar', 'components', SideBar);
