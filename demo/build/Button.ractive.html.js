  ...
  return {
    ...
    execute: function () {
      ...
      var Button_ractive = exports('default', Window.extend({
        template: {v:4,t:[{t:7,e:"tabs",m:[{n:"flat",f:0,t:13},{n:"pad",f:0,t:13},{n:"class-secondary",t:13},{n:"height",f:"dynamic",t:13}],f:[{t:7,e:"tab",m:[{n:"title",f:"Intro",t:13}],f:[{t:7,e:"marked",f:["    The button helper is just a CSS function that gives you Material `<button>`s. When passed to an instance, the styles will be registered with `Ractive.addCSS`, and when passed to a constructor (component), they will augment the existing `css` for the constructor.\n  "]}]}," ",{t:7,e:"tab",m:[{n:"title",f:"Usage",t:13}],f:[{t:7,e:"marked",f:["    ```javascript\n    import plugin from 'raui/es/button';\n\n    Ractive.use(plugin());\n\n    // or\n    MyComponent.use(plugin());\n\n    // or\n    const r = new Ractive();\n    r.use(plugin());\n\n    // or\n    new Ractive({\n      use: [plugin(())]\n    });\n\n    // or\n    const MyComponent = Ractive.extend({\n      use: [plugin()]\n    });\n    ```\n  "]}]}," ",{t:7,e:"tab",m:[{n:"title",f:"Example",t:13}],f:[{t:7,e:"button",f:["Material Button"]}," ",{t:7,e:"button",m:[{n:"class-flat",t:13}],f:["A Flat Button"]}," ",{t:7,e:"button",f:["A Third Button"]}," ",{t:7,e:"button",m:[{n:"class-round",t:13}],f:["+"]},{t:7,e:"br"}," ",{t:7,e:"button",m:[{n:"style",f:"color: #fff; background-color: #07e;",t:13}],f:["Colorful"]}]}]}]},
        use: [plugin()],
        options: {
          title: 'Helper :: Button',
