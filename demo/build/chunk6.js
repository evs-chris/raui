  ...
  return {
    ...
    execute: function () {
      ...
      var Menu = /*@__PURE__*/(function (Ractive) {
        ...
        Menu.prototype.itemDisabled = function itemDisabled (item) {
          if (item.disabled != null) {
            if (typeof item.disabled === 'function') { return item.disabled(item); }
            else { return item.disabled; }
          }
          if (item.disabledRef) {
            var ref = this.get(item.disabledRef);
