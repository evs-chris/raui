  ...
  return {
    ...
    execute: function () {
      ...
      Ractive$1.extendWith(Table, {
        ...
        cssId: 'rtable',
        noCssTransform: true,
        attributes: ['paginate', 'items', 'filter', 'sort', 'helpers', 'fixed', 'allowSelect', 'allowSelectAll', 'border', 'fixedHeader', 'valign', 'noHeader', 'empty'],
        components: {
          table: false,
          Table: false
        },
              ...
              if (v === 'auto' || v === 'virtual' || v instanceof Ractive$1) {
                ...
                if (v === 'virtual') {
                  ...
                  var fn$1 = function () {
                    ...
                    if (!isNumber(offset) || isNaN(offset) || top < virtual.top + pageSize || top > virtual.bottom - pageSize || offset > 0 && top < avg * page) {
