System.register(['./chunk3.js', './chunk4.js', './chunk6.js', './chunk2.js', './chunk8.js', './Hello.ractive.html.js', 'ractive', './chunk14.js', './chunk15.js', './chunk16.js'], function (exports, module) {
  'use strict';
      ...
      var App = Ractive.extend({
        ...
        on: {
          init: function init() {
            ...
            var builtins = ['Hello', 'AceEditor', 'AppBar', 'Autocomplete', 'Button', 'Card', 'Click', 'CodeMirror', 'Date', 'DateInput', 'DatePicker', 'Expand', 'Fade', 'Form', 'Grid', 'JSONEditor', 'Keys', 'Marked', 'MaskedInput', 'Menu', 'NumericInput', 'Popover', 'ScrollSpy', 'Shell', 'Split', 'Swipe', 'Table', 'Tabs', 'Toast', 'Toggle', 'Validate', 'Window'];
