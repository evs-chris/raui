System.register(['./chunk3.js', './chunk4.js', './chunk5.js', './chunk2.js', './chunk6.js', './Hello.ractive.html.js', 'ractive', './chunk9.js'], function (exports, module) {
  'use strict';
  ...
  return {
    ...
    execute: function () {
      ...
      var App = Ractive.extend({
        ...
        on: {
          init: function init() {
            ...
            var builtins = ['Hello', 'AceEditor', 'AppBar', 'Button', 'Card', 'Click', 'CodeMirror', 'Date', 'Expand', 'Fade', 'Form', 'Grid', 'JSONEditor', 'Keys', 'Marked', 'MaskedInput', 'Menu', 'ScrollSpy', 'Shell', 'Split', 'Swipe', 'Table', 'Tabs', 'Toast', 'Toggle', 'Window'];
      ...
      function style$1(data) {
        ...
        var active = Object.assign({}, primary, data('raui.primary.active'), data('raui.form.primary.active'));
