System.register(['./chunk3.js', './chunk4.js', './chunk6.js', './chunk2.js', './chunk7.js', './chunk9.js', './Hello.ractive.html.js', 'ractive', './chunk15.js', './chunk16.js', './chunk17.js'], function (exports, module) {
  'use strict';
  var Shell, AppBar, Menu, Host, style, runner, MenuList, Hello, Ractive$1, tabs, marked, form;
  return {
    ...
    execute: function () {
      ...
      var App = Ractive.extend({
        ...
        on: {
          init: function init() {
            ...
            var builtins = ['Hello', 'AceEditor', 'AppBar', 'Autocomplete', 'Button', 'Card', 'Chart', 'Click', 'CodeMirror', 'Date', 'DateInput', 'DatePicker', 'drag', 'Expand', 'Fade', 'Form', 'Grid', 'JSONEditor', 'Keys', 'Marked', 'MaskedInput', 'Menu', 'NumericInput', 'Popover', 'Runner', 'ScrollSpy', 'Shell', 'SideBar', 'Split', 'Swipe', 'Table', 'Tabs', 'tip', 'Toast', 'Toggle', 'Validate', 'VirtualList', 'Window'];
            ...
            document.body.addEventListener('keydown', function (ev) {
              if ((ev.which === 112 || ev.which === 80) && (ev.ctrlKey || ev.metaKey)) {
                ev.preventDefault();
                ev.stopPropagation();
                this$1.run();
              }
        ...
        setupRunner: function setupRunner(run) {
          var this$1 = this;

          setTimeout(function () {
            run.addPlugin(new MenuList(this$1.findComponent('menu')));
            this$1.run = function () { return run.showHide(); };
          });
        },
      });
      ...
      var app$1 = window.app = new App({ target: '#target' });
